#ifndef MPI_UTILS_ERROR_HPP
#define MPI_UTILS_ERROR_HPP
...
class MpiUtilsError : public std::runtime_error
{
public:
    explicit MpiUtilsError(const std::string &msg)
